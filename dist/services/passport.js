...
exports.default = (function(app, isDev) { return __awaiter(_this, void 0, void 0, function() {
    var verifyFunction;
    var _this = this;
    return __generator(this, function(_a) {
        verifyFunction = function(username, password, done) { return __awaiter(_this, void 0, void 0, function() {
            var _a, err, _b, user, message;
            return __generator(this, function(_c) {
                switch (_c.label) {
                    case 0:
                        console.log("Attempting to verify user '" + username + "'");
                        return [4 /*yield*/, await_to_js_1.default(user_service_1.default.authenticate(username, password))];
                    case 1:
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, await_to_js_1.default(user_service_1.default.getById(id))];
                    case 1:
        ...
        app.use("/authRequired", function(req, res) {
