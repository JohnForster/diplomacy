...
const setupNewFullGame = async () => {
  ...
  const game = res.data;
  const numbers = shuffle(range(1, 25)).map((x) =>
    x.toString().padStart(2, "0")
  );
  const devIDs = [
    "5cd85783c26513e12f695ce2",
    "5cd8988c463115ffdbc672b3",
    "5ce28c5b63ca37c488983f92",
    "5ce28c7563ca37c488983f93",
    "5ce28c9663ca37c488983f94",
    "5ce28cbd63ca37c488983f95",
    "5ce28cd263ca37c488983f96",
  ];
  const prodIDs = [
    "5e8a6040505fed0021be01eb",
    "5e8ad95766a29400215ebe2d",
    "5e8b206400462a0021d55454",
    "5e8b207600462a0021d55455",
    "5e8b208d00462a0021d55456",
    "5e8b20ab00462a0021d55457",
    "5e8b20ea00462a0021d55458",
  ];
