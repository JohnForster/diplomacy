...
// import { IGameTurnDB, IOrder, IPlayerStateDB, IApiStateDB } from '@shared/types'
...
//   getMoves: (id: any) => IOrder[],
//   addMoves: (playerID: any, moves: IOrder[]) => void,
...
// turnSchema.methods.getMoves = function(playerID: any): IOrder[] {
